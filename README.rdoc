...
A plugin to show and filter timelogs across all projects in Redmine. __Compatiable with ruby 1.8.7__

== Installation

Clone this plugin to the plugins directory. Install (redmine_preview_attach_column)[http://www.redmine.org/plugins/redmine_preview_attach_column]
